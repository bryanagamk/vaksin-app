...
@section('header-btn')
    <div>
        <a href="#tambahjenisvaksin" data-toggle="modal" data-target="#tambahjenisvaksin" data-animation="effect-scale"
...
@section('modal-create')
    <div class="modal fade effect-scale" id="tambahjenisvaksin" tabindex="-1" role="dialog" aria-labelledby="modalmyfile"
        aria-hidden="true">
